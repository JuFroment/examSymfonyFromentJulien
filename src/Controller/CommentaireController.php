...
class CommentaireController extends AbstractController
{
    ...
    public function index(CommentaireRepository $commentaireRepository, Article $article): Response
    {
    ...
    public function show(Commentaire $commentaire, Article $article): Response
    {
